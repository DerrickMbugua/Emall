							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{ route('register') }}" name="frm-login" method="POST">
									...
									<fieldset class="wrap-input item-width-in-half ">
										...
										<input type="password" id="frm-reg-cfpass" placeholder="Confirm Password" name="password_confirmation" required autocomplete="new-password">
									</fieldset>
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900" style="margin-right: 50px" href="{{ route('login') }}">
                                        {{ __('Already registered?') }}
                                    </a>
